...
import FadeInSection from "./FadeInSection"; // make sure this is .jsx/.tsx, not .js
  ...
  const projects = [
    {
      title: "LughatulQuran",
      description:
        "🚧 In progress – A Quranic Arabic vocabulary trainer inspired by Anki, featuring intelligent spaced repetition, Supabase-based user progress, and a sleek dark/light UI for immersive learning.",
    ...
    },
    {
      title: "Focus-TreeX",
      description:
        "A productivity app that grows a tree as you focus, featuring streaks, AI coaching, and unlockable trees.",
    ...
    },
    {
      title: "FinanceScope",
      description:
        "Financial dashboard for comparing living costs & salaries across cities worldwide with AI-driven budgeting advice.",
      technologies: [
        "TypeScript",
        "React",
        "Tailwind CSS",
    ...
    },
    {
      ...
      description:
        "AI-powered medical analysis system using computer vision to assess stool samples based on clinical metrics.",
    ...
    },
    {
      ...
      description:
        "A predictive analytics tool for Premier League matches, leveraging machine learning and web scraping.",
      technologies: ["Jupyter", "Flask", "Python", "JavaScript"],
      image:
        "https://images.unsplash.com/photo-1511886929837-354d827aae26?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80",
      github: "https://github.com/hamzaelmi068/PremierLeague_webscraper",
    },
    {
      title: "ZooScope Classifier (ML)",
      description:
        "A Machine Learning project infused with practices of data analytics and real life applications",
    ...
    },
    {
      title: "Worm-GameX",
      description:
        "A simple Worm game built with JavaScript and HTML5 Canvas. Control the snake, eat food, and grow while avoiding collisions.",
