...
const Hero = () => {
  return (
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden hero-bg">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="text-left animate-fade-in order-2 md:order-1">
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 tracking-tight">
              Turning{' '}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-primary-200 to-white pulse-glow"> 
            ...
            <a
              href="#projects"
              className="button-primary group inline-flex items-center gap-2 text-lg px-8 py-4"
            >
              View My Work
          ...
          <div className="order-1 md:order-2 flex justify-center">
            <div className="relative w-64 h-64 md:w-80 md:h-80 floating-animation">
              ...
              <img
                ...
                alt="Hamza's Profile"
                className="relative w-full h-full object-cover rounded-full border-4 border-white/20 shadow-2xl hover:border-white/40 transition-all duration-300"
              />
            </div>
          </div>
        </div>
